...
----
+
The `controller_postinstall_repo_url` variable defines the postinstall repository URL which must include authentication information, as in the following examples:
+
----
